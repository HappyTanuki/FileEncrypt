...
int main() {
  ...
  // test 1
  {
    key = file_encrypt::util::HexStrToBytes(
        "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b");
    // "Hi There"
    data = file_encrypt::util::HexStrToBytes("4869205468657265");
  ...
  {
    // "Jefe"
    key = file_encrypt::util::HexStrToBytes("4a656665");
  ...
  // test 5 was skipped because I am not implemented output truncation
  // test 6
  {
    key = file_encrypt::util::HexStrToBytes(
