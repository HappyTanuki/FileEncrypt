...
class AES256 : public CipherAlgorithm {
 public:
  ...
  void UpdateEncrypt(const CipherAlgorithmInputData& data) final override;
  void UpdateDecrypt(const CipherAlgorithmInputData& data) final override;
  CipherAlgorithmReturnData Encrypt() final override;
  CipherAlgorithmReturnData Decrypt() final override;
 ...
 private:
  ...
  const std::uint8_t S_box[256] = {
      ...
      0xb0, 0x54, 0xbb, 0x16};
  const std::uint8_t Inverse_S_box[256] = {
