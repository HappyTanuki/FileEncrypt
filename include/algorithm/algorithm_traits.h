...
struct AlgorithmTraits<AES<KeyBits>> {
  static inline const std::string name = AESAlgorithmName<KeyBits>();
...
struct AlgorithmTraits<
  ...
  static inline const std::string name = "CBC";
  static constexpr const std::uint32_t bits = KeyBits;
};
template <std::uint32_t BlockSizeBits, std::uint32_t KeyBits,
          std::uint32_t BufferSize>
struct AlgorithmTraits<
  ...
  static inline const std::string name = "ECB";
  static constexpr const std::uint32_t bits = KeyBits;
};
template <std::uint32_t BlockSizeBits, std::uint32_t KeyBits,
          std::uint32_t BufferSize>
struct AlgorithmTraits<
  ...
  static inline const std::string name = "CTR";
  static constexpr const std::uint32_t bits = KeyBits;
};
