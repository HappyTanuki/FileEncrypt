...
class SHA256 : public HashAlgorithm {
 public:
  struct HashAlgorithmReturnData Digest(
      const HashAlgorithmInputData& data) const override;
 ...
 private:
  ...
  const std::uint32_t H0[8] = {0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a,
